...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DGPSegmentViewController *navigationController = [[DGPSegmentViewController alloc] initWithRootViewController:pageViewController];
    ...
    demo2.view.backgroundColor = [UIColor yellowColor];
